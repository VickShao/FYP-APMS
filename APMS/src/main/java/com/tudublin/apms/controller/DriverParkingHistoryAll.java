...
@WebServlet("/api/driver_parking_history_all")
public class DriverParkingHistoryAll extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (UserVRN u:userVRNList) {
                ...
                List<ParkingRecord> parkingRecordList = parkingRecordService.selectAllParkingRecordByVRN(vrn);
